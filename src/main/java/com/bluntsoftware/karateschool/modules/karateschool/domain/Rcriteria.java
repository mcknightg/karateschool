...
@Table(name = "\"rcriteria\"")
public class Rcriteria implements CustomDomain<Rcriteria> {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "rcriteria_id_seq")
    @SequenceGenerator(name = "rcriteria_id_seq", allocationSize = 1, sequenceName = "rcriteria_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
    ...
    @ManyToOne(cascade = {CascadeType.PERSIST, CascadeType.MERGE})
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE})
    @JoinColumn(name = "\"criteria\"", nullable = true )
    ...
    public int compareTo(Rcriteria rcriteria) {
        return 0;
    }

    @Override
    public Object clone() throws CloneNotSupportedException {
        Rcriteria entity = (Rcriteria)super.clone();
        entity.setId(null);
        return entity;
    }
}