...
@Table(name = "\"rank\"")
public class Rank implements CustomDomain<Rank> {
    ...
    @SequenceGenerator(name = "rank_id_seq", allocationSize = 1, sequenceName = "rank_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
